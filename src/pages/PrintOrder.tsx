    ...
    <section className="mx-auto max-w-3xl px-4 sm:px-6">
      <div className="rounded-[2rem] border-2 border-gold/60 bg-forest-dark px-6 py-10 text-center text-white shadow-2xl sm:px-12 sm:py-12">
        <div className="mx-auto mb-4 h-32 w-32 [perspective:640px]" aria-label="KiwiKoru doing a happy dance" role="img">
          <div className="kiwikoru-payment-dance relative h-full w-full [transform-style:preserve-3d]" style={{ backgroundImage: "url('/pets/kiwikoru/spritesheet.webp')", backgroundRepeat: 'no-repeat', backgroundSize: '800% 1100%', backgroundPosition: '14.2857% 30%', transformOrigin: '50% 88%', filter: 'saturate(1.08) brightness(1.05)', animation: 'kiwikoru-payment-dance 2.9s cubic-bezier(.45,.05,.25,1) infinite' }}><span aria-hidden className="absolute left-[46%] top-[55%] h-[8%] w-[12%] rounded-full bg-[#888d31] [transform:rotate(-8deg)]" /><svg aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full" viewBox="0 0 100 100" fill="none"><ellipse cx="50" cy="31" rx="19" ry="14" fill="#929b34" /><path d="M35 29 Q40 36 45 29" stroke="#28382a" strokeWidth="3.7" strokeLinecap="round" /><path d="M55 29 Q60 36 65 29" stroke="#28382a" strokeWidth="3.7" strokeLinecap="round" /><ellipse cx="34" cy="39" rx="5.2" ry="2.8" fill="#d6b072" opacity=".72" /><ellipse cx="66" cy="39" rx="5.2" ry="2.8" fill="#d6b072" opacity=".72" /><path d="M46 19 L48 19" stroke="#fff4c7" strokeWidth="3.2" strokeLinecap="round" opacity=".9" /></svg></div>
        </div>
