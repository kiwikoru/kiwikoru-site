  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2">
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl focus-gold group"
        aria-label="Chat with us on WhatsApp"
      >
        <WhatsAppLogo className="w-7 h-7 text-white transition-transform duration-300 group-hover:scale-110" />
      </a>
    </div>
  )
}
